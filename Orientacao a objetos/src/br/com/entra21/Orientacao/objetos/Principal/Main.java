...
public class Main {
	...
	private static void aprenderHeranca() {
		...
		Diretor diretor1 = new Diretor("Paulo", (byte) 80, "Entra21", (byte) 10);
		diretor1.setName("Paulo");


		Funcionario funcionario1 = new Funcionario();
		funcionario1.setIdade((byte) 33);
		funcionario1.setName("Carlos");
		funcionario1.setCargoAtual("Programador Jr");
		funcionario1.setSalario(4000);

		System.out.println("Ola meu nome e " + funcionario1.getName() + " e tenho " + funcionario1.getIdade() + " anos");
